# A priori power analyses for Experiments 1, 2, and 3.

# Examines the effects of task timing, difficulty, and appeal on task choices.
# It calculates suggested sample sizes for different effect sizes and power levels
